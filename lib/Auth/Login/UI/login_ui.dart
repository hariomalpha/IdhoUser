...
import 'package:cabira/generated/assets.dart';
          ...
          children: [
            ...
            InkWell(
              onTap: () async {
                ...
                if (!agree) {
                  setSnackbar("Please accept terms and conditions", context);
                  return;
                }
                /*if (passCon.text == "" ||
                    passCon.text.length < 8) {
              ...
              child: AnimatedContainer(
                ...
                width: 90.w,
                height: 6.h,
                decoration: boxDecoration(radius: 10, bgColor: Color(0xFFdc2328)),
                child: Center(
                  child: !loading
                      ? text("Continue",
                          fontFamily: fontMedium,
