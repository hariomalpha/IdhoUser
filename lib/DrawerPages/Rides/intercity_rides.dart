                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        Text(
                                                          '₹${rideList[index].shareUserData![rideList[index].selectedUser!].totalAmount}',
                                          ...
                                          InkWell(
                                            onTap: () {
                                              ...
                                              final dynamicLinkParams =
                                                ...
                                                link: Uri.parse(
                                                    "https://developmentalphawizz.com/idho/?${rideList[index].bookingId}"),
                                                uriPrefix:
                    ...
                    child: Column(
                      children: [
                        AnimatedTextKit(
                          animatedTexts: [
                            ColorizeAnimatedText(
                              "Cancellation Charge ₹${rideList[index].cancelCharge} is deducted from wallet.",
