...
class _WelComeScreenState extends State<WelComeScreen> {
  List<MainModel> bannerList = [
    MainModel(
        "1",
        "IDHO allows users to easily set their preferred drop-off location, making their ride booking process quicker and more convenient",
        "assets/banner1.png",
        Color(0xfffffff),
        "CHOOSE DESTINATION",
        "",
    ...
    MainModel(
        "2",
        "Effortlessly book your ride and reach your destination with ease using IDHO - Your reliable transportation partner",
        "assets/banner2.png",
        Color(0xfffffff),
        "BOOK RIDE",
        "",
    ...
    MainModel(
        "3",
        "Your journey with IDHO starts here. Sit back,relax, and enjoy the ride",
        "assets/banner3.png",
        Color(0xfffffff),
        "ENJOY IDHO TRIP",
        "",
