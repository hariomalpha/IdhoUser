...
final String appName = 'IDHO';
bool notificationStatus = true;
int notificationId = 1;
final String packageName = 'com.idho.user';
...
// final String baseUrl = "https://alphataxi.productsalphawizz.com/api/Authentication/";

// final String baseUrl = "https://idho.in/api/Authentication/";
final String baseUrl = "https://book.idho.in/api/Authentication/";

// final String baseUrl = "https://developmentalphawizz.com/idho/api/Authentication/";
    //"https://192.168.0.50/TAXI_APP/Authentication";
    // 'https://developmentalphawizz.com/ridex/api/Authentication/';

final String baseUrl1 = "https://book.idho.in/api/";
// final String baseUrl1 = "https://idho.in/api/";

    //"https://192.168.0.50/TAXI_APP/";
    // 'https://developmentalphawizz.com/ridex/api/';
